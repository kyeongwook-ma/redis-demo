...
@RestController
public class RedisPubSubController implements RedisMessageListener {
    private final RedisTemplate<String, String> redisTemplate;

    public RedisPubSubController(RedisTemplate<String, String> redisTemplate, ObjectMapper objectMapper) {
